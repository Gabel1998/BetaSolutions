...
//  Calculate total actual and estimated hours for a project
    void testProjectHoursCalculations() {
        ...
        assertThat(actual).isEqualTo(143.75);
        assertThat(estimated).isEqualTo(140.0);
    }
...
//  Calculate project hours for multiple projects
    void testCalculateProjectHoursMap() {
        ...
        assertThat(map.get(1000).get("actualHours")).isEqualTo(143.75);
...
//  Adjust estimated hours based on employee efficiency
    void testAdjustEstimatedHours() {
        ...
        assertThat(adjusted).isCloseTo(140.0, withinPercentage(0.1));    }

    @Test
//  Create, update and delete a project
    void testCrudProject() {
        // Create a new Project (id is still null here)
        ...
        // Immediately re-load it from the DB so you get the real id
        ...
        // Now persisted.getId() is non-null, and you can continue your CRUD assertions:
